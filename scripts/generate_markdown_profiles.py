...
def _section_rating(rd: dict) -> str:
    """Build Gravel God Rating section with 14-dimension table."""
    rating = rd.get("gravel_god_rating", {})
    if not rating:
        return ""
...
def generate_profile(
    ...
    for builder in [
        ...
        if builder is _section_verdict and slug in training_plan_slugs:
            ...
            sections.append(
                ...
                f"It covers this race's terrain, climate, demand profile, key workouts, "
                f"timeline, and fueling."
            )
    ...
    sections.append(
        ...
        f'Cite as: "Gravel God Cycling — {race_name}". Canonical: '
...
def main():
    ...
    for slug in slugs:
        ...
        if not args.dry_run:
            ...
            out_file = args.output_dir / f"{slug}.md"
